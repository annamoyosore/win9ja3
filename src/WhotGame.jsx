...
history: pushHistory(
g,
🏆 ${   winnerIdx === 0 ? g.hostName : g.opponentName   } wins match
)
};
}
...
return (
  ...
  <div style={styles.bg}>  <div style={styles.box}>  
