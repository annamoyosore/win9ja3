...
const myIdx2 = game.players.indexOf(userId);
const oppIdx2 = myIdx2===0?1:0;

const hand = game.hands[myIdx2] || [];
const oppCards = game.hands[oppIdx2]?.length || 0;
