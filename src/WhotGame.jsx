...
export default function SnakeGame({ gameId, userId }) {
  ...
  async function playTurn() {
    ...
    const winner = newPos >= SIZE ? player : "";
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.info}>
        🎲 Dice: {dice} <br />
        Turn: <b>{turn === "A" ? "Player A 🟢" : "Player B 🔵"}</b><br />
        💰 Pot: ₦{game.pot || 0}
      </div>
      ...
      <div style={styles.boardWrapper}>
        ...
        {["A", "B"].map((p) => (
          <div
            ...
            style={{
              ...styles.token,
              ...getCoords(positions[p]?.slice(-1)[0] || 1),
